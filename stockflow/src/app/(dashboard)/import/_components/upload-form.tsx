      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="md:col-span-2">
          ...
          <select name="branch" defaultValue="auto" className="input">
            <option value="auto">Auto &mdash; read from each row&apos;s branch column</option>
          ...
          <p className="text-xs text-muted mt-1">
            For sales exports, choose Auto &mdash; the Class column tells us each transaction&apos;s branch.
          </p>
        </div>
      </div>
