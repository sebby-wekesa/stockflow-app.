      ...
      <div>
        ...
        <div className="form-group mb-16">
          ...
          <select className="form-input">
            <option>Select a saved design template</option>
          </select>
        </div>
        ...
        <div className="form-group mb-16">
          ...
          <input className="form-input" type="text" placeholder="Client or reference" />
        </div>
        <div style={{background:'var(--surface2)',border:'1px solid var(--border)',borderRadius:'var(--radius-sm)',padding:'12px',marginBottom:'16px'}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:'4px'}}>
            <span style={{background:'rgba(139,124,248,0.12)',color:'var(--purple)',fontSize:'11px',padding:'3px 8px',borderRadius:'10px'}}>
              Select a design to load stages
            </span>
          </div>
        </div>
