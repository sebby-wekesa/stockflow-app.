...
const ACCOUNTING_NAV_ITEMS: NavItem[] = [
  ...
  { label: "Payroll", href: "/accounting?view=workspace&tab=payroll" },
  ...
  switch (role) {
    ...
    case 'ADMIN':
      return [
        ...
        { label: "Raw Material Consumption", href: "/raw-material-consumption" },
        { label: "Finished goods production", href: "/finishedgoods" },
