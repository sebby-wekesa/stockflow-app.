...
import { getCreditors } from "@/actions/accounting-ar-ap";
...
export default async function CreditorsPage() {
  ...
  return (
    <div className="dashboard-content">
      ...
      {rows.length === 0 ? (
        <div className="card" style={{ padding: 40, textAlign: "center", color: "var(--muted)" }}>No supplier balances yet.</div>
      ) : (
      ...
      <p style={{ fontSize: 12, color: "var(--muted)", marginTop: 12 }}>
        Record a supplier payment from the Banking page to reduce these balances.
      </p>
    </div>
  );
}
